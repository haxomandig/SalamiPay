    ...
    <div className="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <section>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
          ...
          <div>
            <FAQItem
              q="Does SalamiPay process payments?"
              a="No. SalamiPay is a pledge-tracking platform. It records who intends to contribute and how much. Actual payment is arranged directly between contributors and the event organizer via bKash, Nagad, bank transfer, or any method you choose."
            />
            <FAQItem
              q="Is SalamiPay free?"
